...
#define SCRIBE_SYSCALL_EXTRA		0x00000100
#define SCRIBE_SIG_COOKIE		0x00000200
#define SCRIBE_RES_EXTRA		0x00000400
#define SCRIBE_DATA_EXTRA		0x00000800
#define SCRIBE_DATA_DET			0x00001000
#define SCRIBE_FENCE_ALWAYS		0x00002000
#define SCRIBE_REGS			0x00004000
